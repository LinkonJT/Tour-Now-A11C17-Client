...
>
  ...
  <div className="max-w-md">
    ...
    animate={{scale: 1, transition: { duration: 2 }}}  className="mb-5 text-black text-xl md:text-5xl font-bold"><motion.span animate={{color: ['#ff5733', '#68ff33', '#33caff', '#f3364e' ], transition: { duration: 5 , repeat: Infinity} }}>Your Next Adventure Starts Now!</motion.span></motion.h1>
