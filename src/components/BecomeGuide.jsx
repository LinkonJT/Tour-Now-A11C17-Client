...
const BecomeGuide = () => {
    ...
    return (
        <div className="w-11/12 mx-auto">
                      <section className=" p-8 my-10 rounded-2xl shadow-lg shadow-amber-100">
  <div className="flex flex-col md:flex-row items-center gap-6">
    ...
    <div>
      ...
      <NavLink to={user? '/add-package' : '/signin'} className="btn btn-outline btn-primary mt-3">Start Guiding</NavLink>
    </div>
  </div>
</section>
        </div>
